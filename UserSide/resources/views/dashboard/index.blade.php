        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="./dashboard/images/logo.png" alt="">
                <img class="logo-compact" src="./dashboard/images/logo-text.png" alt="">
                <img class="brand-title" src="./dashboard/images/logo-text.png" alt="">
            </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
							...
							<li><a href="page-general-products.html">Categories</a></li>
							<li><a href="page-general-products.html">Foods</a></li>
							...
							<li><a href="page-general-products.html">Staff</a></li>
